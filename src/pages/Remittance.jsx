  ...
  return (
    <div className="w-full">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10">
            {remittanceTypes.map((item, index) => {
              ...
              const faceStyle = {
                ...
                bborderLeftColor: "var(--brand-green)",
                borderRadius: "20px",
      ...
      <section className="py-20 bg-gradient-to-r from-[color:var(--brand-green)] via-emerald-800 to-[#f6a800] text-white">
        <div className="max-w-6xl mx-auto px-4">
          <h3 className="text-xl md:text-3xl font-bold text-center mb-12">
            Remittance Application Process
          </h3>

          <div className="relative">
            <div className="hidden md:block absolute left-1/2 top-0 bottom-0 w-1 bg-white/20 rounded-full"></div>
            ...
            <div className="grid md:grid-cols-4 gap-10">
              {[ 
                ...
                { title: "Transfer Completion", icon: <FaHandshake /> },
              ].map((step, i) => (
                <motion.div
                  key={i}
      ...
      <section className="w-full py-20 text-center">
        <div className="mx-4 md:mx-10 bg-gradient-to-r from-[color:var(--brand-green)] via-emerald-800 to-[#f6a800] text-white rounded-3xl shadow-xl px-8 md:px-16 py-20">
          ...
          <p className="text-base md:text-lg opacity-90 mb-8">
            Our team is ready to guide you toward the best remittance option.
          </p>
          <motion.a
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.9 }}
