              ...
              return (
                ...
                >
                  <div style={containerStyle}>
                    <div style={faceStyle}>
                      <div className="text-[color:var(--brand-blue)] text-6xl mb-4">
                        {item.icon}
                      </div>
                      <h4 className="font-semibold text-lg text-[color:var(--brand-blue)]">
                        {item.title}
                      </h4>
                    </div>
          ...
          <div className="relative">
            ...
            <div className="grid md:grid-cols-4 gap-10">
              {[ 
                ...
                { title: "Loan Disbursement", icon: <FaHandshake />, color: "var(--brand-blue)" },
              ].map((step, i) => (
                <motion.div
                  key={i}
                ...
                >
                  ...
                  <h4 className="font-semibold text-base text-gray-700 text-center">
                    {step.title}
                  </h4>
                  {i < 3 && (
