  ...
  const remittanceTypes = [
    ...
    },
    {
      ...
      points: [
        ...
        "Low fees for multiple transfers",
    ...
    <div className="w-full">
      ...
      >
        ...
        <div className="relative text-center text-white px-4">
          <div className="text-sm mb-6 opacity-80">
            ...
            <span className="opacity-100 font-semibold">Remittance Services</span>
          </div>
          ...
          >
            Fast, secure, and reliable remittance solutions for domestic and international money transfers.
          </motion.p>
        </div>
      </section>
      ...
      <section className="py-25 bg-white">
        <div className="max-w-6xl mx-auto px-4 flex flex-col items-center gap-10 text-center">
          ...
          <p className="text-gray-700 leading-7 text-sm md:text-base max-w-3xl">
            We provide a variety of remittance services for personal and business needs. 
            Transfer money domestically or internationally with transparency and speed.
          </p>
        </div>
      </section>
      ...
      <section ref={counterRef} className="py-16 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4 grid grid-cols-2 md:grid-cols-4 gap-10 text-center">
          {[
            { title: "Transfers Made", count: 2500, color: "var(--brand-red)" },
            { title: "Happy Customers", count: 1800, color: "var(--brand-green)" },
            { title: "Years of Service", count: 10, color: "var(--brand-blue)" },
            { title: "Countries Covered", count: 35, color: "var(--brand-red)" },
          ].map((item, i) => (
      ...
      {/* ================= REMITTANCE APPLICATION PROCESS ================= */}
          ...
          <div className="relative">
            ...
            <div className="grid md:grid-cols-4 gap-10">
              {[ 
                ...
                { title: "Transfer Completion", icon: <FaHandshake />, color: "var(--brand-blue)" },
              ].map((step, i) => (
                <motion.div
                  key={i}
      ...
      <section className="py-20 bg-[color:var(--brand-blue)] text-white text-center rounded-t-[70px] md:rounded-t-[140px]">
        <motion.h3 initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} className="text-xl md:text-3xl font-bold">
          Need Remittance Assistance?
        </motion.h3>

        <p className="text-sm md:text-base mt-2 opacity-90">
          Our team is ready to guide you through fast and secure remittance transfers.
        </p>

        <motion.a
          whileHover={{ scale: 1.05 }}
          whileTap={{ scale: 0.9 }}
          href="#remittance-form"
